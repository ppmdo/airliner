...
func main() {
    ...
    bot, err := tgbotapi.NewBotAPI("1815941771:AAHDzmF2KLNp45XlD14_Bi0iXmocekf2gaE")
	if err != nil {
		log.Panic(err)
	}
	log.Printf("Authorized on account %s", bot.Self.UserName)

    msg := tgbotapi.NewMessage(-470314890, "Hi there... Query operation starting...")
	bot.Send(msg)
	var wg sync.WaitGroup
